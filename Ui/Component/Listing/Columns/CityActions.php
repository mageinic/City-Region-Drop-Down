...
/**
 * CityRegionPostcode CityActions Class
 */
class CityActions extends Column
{
    public const EDIT_PAGE_ROUTE   = 'cityregionpostcode/city/edit';
    public const DELETE_PAGE_ROUTE = 'cityregionpostcode/city/delete';
