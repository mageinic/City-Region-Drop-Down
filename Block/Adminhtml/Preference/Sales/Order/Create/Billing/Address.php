...
namespace MageINIC\CityRegionPostcode\Block\Adminhtml\Preference\Sales\Order\Create\Billing;

use Magento\Customer\Api\Data\AttributeMetadataInterface;
use Magento\Customer\Api\Data\OptionInterface;
use Magento\Framework\Data\Form\AbstractForm;
use Magento\Sales\Block\Adminhtml\Order\Create\Billing\Address as CoreAddress;

/**
 * cityRegionPostcode Create Billing Address Class
 */
class Address extends CoreAddress
{
     ...
     * @return array
     */
    public function customSortAttributes(array $attributes, array $order): array
    {
        $insertAt = 0;
