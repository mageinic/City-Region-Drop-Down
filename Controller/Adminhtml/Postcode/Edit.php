...
/**
 * Edit CityRegionPostcode postcode action.
 */
class Edit extends Action implements HttpGetActionInterface
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('MageINIC_CityRegionPostcode::postcode_postcode')
            ...
            ->addBreadcrumb(__('Manage Postcode'), __('Manage Postcode'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('current_postcode', $model);
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getPostcode() : __('New Postcode'));
