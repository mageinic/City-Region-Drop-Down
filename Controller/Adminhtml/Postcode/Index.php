...
class Index extends Action implements HttpGetActionInterface
{
     ...
     * @see _isAllowed()
     */
    public const ADMIN_RESOURCE = 'MageINIC_CityRegionPostcode::postcode';
    /**
     * @var PageFactory
     */
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('MageINIC_CityRegionPostcode::postcode_postcode');
        $resultPage->addBreadcrumb(__('CityRegionPostcode'), __('CityRegionPostcode'));
        $resultPage->addBreadcrumb(__('Manage Postcode'), __('Manage Postcode'));
